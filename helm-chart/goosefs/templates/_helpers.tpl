...
{{- define "goosefs.logserver.resources" -}}
resources:
  limits:
...
{{- define "goosefs.logserver.secretVolumeMounts" -}}
...
{{- define "goosefs.logserver.log.volume" -}}
...
{{- define "goosefs.imagePullSecrets" -}}
imagePullSecrets:
